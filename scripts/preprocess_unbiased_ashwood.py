...
command would be:
```console
> python scripts/preprocess_unbiased_ashwood -i data/foo -o data/bar
```
...
DEFAULT_OUTPUT_DIR = 'data/preprocessed/ashwood_unbiased'


def parse_args():

    parser = argparse.ArgumentParser(
        description='select and preprocess unbiased blocks (Ashwood criteria).'
    )
    parser.add_argument(
        '-i', '--input', type=str,
